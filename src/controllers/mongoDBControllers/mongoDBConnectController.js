...
class MongoDBConnectController {
  ...
  connectMongoDB() {
    ...
    if (CRED_OBJECTS.MONGO.password) {
      ...
      url = `mongodb://${CRED_OBJECTS.MONGO.user}:${encodeURIComponent(CRED_OBJECTS.MONGO.password)}@cluster0-shard-00-00-pvtht.mongodb.net:27017,cluster0-shard-00-01-pvtht.mongodb.net:27017,cluster0-shard-00-02-pvtht.mongodb.net:27017/test?ssl=true&replicaSet=Cluster0-shard-0&authSource=admin&retryWrites=true&w=majority`;
